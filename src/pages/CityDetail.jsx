      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-900 p-8 rounded-[2.5rem] shadow-2xl text-center border border-white/20 h-full flex flex-col justify-center">
          ...
          <div className="grid grid-cols-3 bg-black/30 rounded-3xl p-6 backdrop-blur-md border border-white/10">
            <div className="flex flex-col items-center border-r border-white/10"><Thermometer size={20} className="text-orange-300 mb-1"/><span className="font-bold">{Math.round(mainInfo.main.feels_like)}°</span><span className="text-[10px] opacity-50 uppercase">Senzație</span></div>
            <div className="flex flex-col items-center border-r border-white/10"><Droplets size={20} className="text-blue-300 mb-1"/><span className="font-bold">{mainInfo.main.humidity}%</span><span className="text-[10px] opacity-50 uppercase">Umiditate</span></div>
            <div className="flex flex-col items-center"><Wind size={20} className="text-emerald-300 mb-1"/><span className="font-bold">{mainInfo.wind.speed}</span><span className="text-[10px] opacity-50 uppercase">Vânt</span></div>
          </div>
        </div>
